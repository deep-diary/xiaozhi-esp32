...
| 文档 | 说明 |
|------|------|
| [docs/开源产品板参考-不倒翁.md](./docs/开源产品板参考-不倒翁.md) | 产品级开源板 Top10 参考；功能先在 `deep-dog` 迭代，再可配置移植到本板 |
| [`deep-dog/FEATURE_FLAGS.md`](../deep-dog/FEATURE_FLAGS.md) | deep-dog 功能开关与联调剖面（移植前的配置权威入口） |
